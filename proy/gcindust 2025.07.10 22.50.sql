...
-- Tiempo de generación: 11-07-2025 a las 03:55:45
...
(1, 'Veterinaria', 'un sato perro', 'ss dfg   sdefgdsfg', '3453', 'rtr@tt.mp'),
(4, 'Agropecuaria', 'Pedro Pi', 'Marabuzal 23, esquina Pino', '34234', '2222@dd.com'),
(6, 'Desmonte y Construccion', 'Antonio', 'Pinar del Rio', '487699098', 'edescon@pinar.cu'),
(3, 'Empresa CISCO', 'Elio', 'Cuba', '1234565', 'lei@pr.cu');
...
CREATE TABLE IF NOT EXISTS `grupos_proyecto` (
  ...
  KEY `id_proyecto` (`id_proyecto`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci COMMENT='empieza con datos nulos, despues se llena';
...
(3, 5, 'Calidad Esteras', NULL, NULL, NULL, 0),
(4, 5, 'Envases Terminados', NULL, NULL, NULL, 0);
...
('1', 'Admin ', 'Sistema', 1, 1, NULL, 'rey', '123'),
('01284341234', 'Marlon', 'Salazar', 8, 2, NULL, 'MarlZ', '123'),
('32231231231', 'Posible Tipo', 'Son sus Ap', 8, 2, NULL, 'rh01', '123'),
('cl1', 'Ruben', 'Perdomo', 2, 4, NULL, 'cl1', '123'),
('e2', 'Iluminado', 'Zulueta', 2, 3, NULL, 'exp2', '123'),
('e3', 'Joaquin', 'Arrobarrueda', 2, 3, NULL, 'exp3', '123'),
('23232342342', 'Pedro Pabl', 'Perez', 2, 3, NULL, 'exp.perez', '123'),
('00110662326', 'Julio', 'Soto', 10, 2, NULL, 'Drago', '123'),
('00122495959', 'Carlos', 'Santos', 5, 2, NULL, 'Car', '123');
...
(1, 'Calidad mayonesa Conchita', '01284341234', '2025-06-24 00:00:00', '12000', 25, 1, 'Aceptado'),
(2, 'Calidad de Agua', '01284341234', '2025-07-01 00:00:00', '22', 22, 4, 'Denegado'),
(3, 'Luz de Zona', '00110662326', '2025-07-05 00:00:00', '23233', 33333, 3, 'Aceptado'),
(4, 'Colas de Zorra.Camiones', '00110662326', '2025-07-02 00:00:00', '2222', 1122, 3, 'Denegado'),
(5, 'Envases de Carton', '00110662326', '2025-07-04 00:00:00', '11', 11, 4, 'Aceptado'),
(6, 'Mango', '00122495959', '2025-07-10 00:00:00', '20000', 3, 6, 'Propuesto'),
(7, 'Aceite', '00122495959', '2025-07-10 00:00:00', '41000', 4, 4, 'Propuesto'),
(8, 'Boniato', '00122495959', '2025-07-08 00:00:00', '63000', 7, 4, 'Aceptado'),
(9, 'Salud trabajador pesquero', '00110662326', '2025-06-03 00:00:00', '200', 4, 4, 'Propuesto');
