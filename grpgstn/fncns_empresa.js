   ...
   if ($('#'+paramsTableTrName+'_wrapper')[0]) {
    ...
    $('#'+paramsTableTrName).DataTable({
        columns:[
            ...
            { title: 'Responsable ',data:'responsable_empresa'}, 
            { title: 'Dcc ',data:'dcc_empresa'}, 
            { title: 'Telefono ',data:'cell_empresa'}, 
...
empForm_onPage.addEventListener( 'submit' , async (e) =>{
   e.preventempFault();
    ...
    let de_data= await submitForm(new FormData (empForm_onPage) ,url_emp);
